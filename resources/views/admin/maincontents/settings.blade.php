            ...
            <div class="tab-pane fade pt-3" id="tab9">
              ...
              <form method="POST" action="{{ url('admin/email-template') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <textarea type="text" name="email_template_contactus" class="form-control ckeditor" id="email_template_contactus" rows="5"><?=$setting->email_template_contactus?></textarea>
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn btn-primary">Submit</button>
            ...
            <div class="tab-pane fade pt-3" id="tab6">
              ...
              <form method="POST" action="{{ url('admin/footer-settings') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <textarea type="text" name="footer_description" class="form-control ckeditor" id="footer_description" rows="5"><?=$setting->footer_description?></textarea>
                  </div>
                </div>
