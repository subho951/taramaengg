...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
  ...
  <script src="<?=env('ADMIN_ASSETS_URL')?>assets/js/plugins/ckeditor.js?v=20260613"></script>
  <script>
    document.querySelectorAll('textarea.ckeditor').forEach(function (textarea) {
      ClassicEditor.create(textarea).then(function (editor) {
        ...
        const feedback = textarea.parentElement.querySelector('.editor-invalid-feedback');

        editor.model.document.on('change:data', function () {
          textarea.value = editor.getData();
          if (feedback && editor.getData().replace(/<[^>]*>|&nbsp;/gi, '').trim()) {
        ...
        if (form) {
          form.addEventListener('submit', function (event) {
            ...
            if (textarea.dataset.editorRequired === 'true' && !editorData.replace(/<[^>]*>|&nbsp;/gi, '').trim()) {
  ...
  <script src="<?=env('ADMIN_ASSETS_URL')?>assets/js/pages/data-basic-custom.js?v=20260613"></script>
